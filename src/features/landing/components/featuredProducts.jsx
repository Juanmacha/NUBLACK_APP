...
function FeaturedProducts({
    ...
    const handleAddToCart = (producto) => {
        console.log('handleAddToCart called with:', producto);
    ...
    // Si no hay categorías o productos, mostrar mensaje
    if (!loading && (categories.length === 0 || activeProducts.length === 0)) {
        return (
            <section id="productos" className="w-full p-12 md:py-24 lg:py-32 bg-[#0a0a0a]">
                <div className="container px-4 md:px-6">
                    ...
                    <div className="text-center py-12">
                        ...
                        <h3 className="text-xl font-semibold text-gray-300 mb-2">No hay productos disponibles</h3>
                        <p className="text-gray-500">
                            {categories.length === 0 
                                ? "Primero debes crear categorías en el panel de administrador"
                                : "Aún no se han agregado productos. Contacta al administrador."
                            }
                        </p>
                    </div>
                </div>
        ...
        <section id="productos" className="w-full p-12 md:py-24 lg:py-32 bg-[#0a0a0a]">
            <div className="container px-4 md:px-6">
                            ...
                            <div className="p-4">
                                ...
                                <div className="flex items-center mb-2">
                                    {[...Array(5)].map((_, i) => (
                                        <svg
                                            key={i}
                                            className={`w-4 h-4 ${i < Math.floor(producto.rating || 4.5)
                ...
                {filteredProducts.length > 0 && (
                        ...
                        {Math.min(indiceFin, filteredProducts.length)} de {filteredProducts.length} productos
                        </div>
                )}
            </div>
        </section>
